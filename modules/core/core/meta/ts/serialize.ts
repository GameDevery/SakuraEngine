  ...
  static header(header: db.Header) {
    ...
    b.$namespace("skr", (_b) => {
      ...
      header.enums.forEach((enum_) => {
        b.$line(`template <>`);
        b.$line(
          `struct ${header.parent.config.api} EnumSerdeTraits<${enum_.name}> {`,
        );
        b.$indent((_b) => {
          b.$line(
            `static skr::StringView to_string(const ${enum_.name}& value);`,
          );
          b.$line(
            `static bool from_string(skr::StringView str, ${enum_.name}& value);`,
          );
        });
        b.$line(`};`);
      });
      ...
      header.records.forEach((record) => {
        b.$line(`template <>`);
        b.$line(
          `struct ${header.parent.config.api} JsonSerde<${record.name}> {`,
        );
        b.$indent((_b) => {
          b.$line(
    ...
    b.$namespace("skr", (_b) => {
      header.records.forEach((record) => {
        b.$line(`template<>`);
        b.$line(
          `struct ${header.parent.config.api} BinSerde<${record.name}> {`,
        );
        b.$indent((_b) => {
  ...
  static source(main_db: db.Module) {
    ...
    b.$namespace("skr", (_b) => {
      ...
      main_db.each_enum((enum_) => {
        ...
        // to string
        b.$line(
          `skr::StringView EnumSerdeTraits<${enum_.name}>:: to_string(const ${enum_.name}& value){`,
        );
        b.$indent((_b) => {
          b.$line(`switch (value) {`);
          b.$indent((_b) => {
            enum_.values.forEach((enum_value) => {
              b.$line(
                `case ${enum_.name}::${enum_value.short_name}: return u8"${enum_value.short_name}";`,
              );
            });
            b.$line(
              `default: SKR_UNREACHABLE_CODE(); return u8"${enum_.name}::__INVALID_ENUMERATOR__";`,
            );
          });
          b.$line(`}`);
        });
        ...
        // from string
        b.$function(
          `bool EnumSerdeTraits<${enum_.name}>::from_string(skr::StringView str, ${enum_.name}& value)`,
          (_b) => {
            ...
            record.fields.forEach((field) => {
              ...
              b.$scope((_b) => {
                ...
                b.$if([`jSlot.has_value()`, (_b) => {
                  b.$if([
                    `!json_read<${field.signature()}>(r, v.${field.name})`,
                    (_b) => {
                      b.$line(
        ...
        b.$function(
          ...
          (_b) => {
            ...
            record.fields.forEach((field) => {
              ...
              b.$line(
                `if (!json_write<${field.signature()}>(w, v.${field.name})) return false;`,
              );
            });
        ...
        b.$function(
          ...
          (_b) => {
            ...
            record.fields.forEach((field) => {
              ...
              b.$if([
                `!bin_read<${field.signature()}>(r, v.${field.name})`,
                (_b) => {
                  b.$line(
        ...
        b.$function(
          ...
          (_b) => {
            ...
            record.fields.forEach((field) => {
              ...
              b.$if([
                `!bin_write<${field.signature()}>(w, v.${field.name})`,
                (_b) => {
                  b.$line(
