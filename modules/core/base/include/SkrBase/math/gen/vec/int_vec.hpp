...
struct int2 {
    ...
    // compare operator
    bool2 friend operator==(const int2& lhs, const int2& rhs);
    bool2 friend operator!=(const int2& lhs, const int2& rhs);
    bool2 friend operator<(const int2& lhs, const int2& rhs);
    bool2 friend operator<=(const int2& lhs, const int2& rhs);
    bool2 friend operator>(const int2& lhs, const int2& rhs);
...
struct int3 {
    ...
    // compare operator
    bool3 friend operator==(const int3& lhs, const int3& rhs);
    bool3 friend operator!=(const int3& lhs, const int3& rhs);
    bool3 friend operator<(const int3& lhs, const int3& rhs);
    bool3 friend operator<=(const int3& lhs, const int3& rhs);
    bool3 friend operator>(const int3& lhs, const int3& rhs);
...
struct int4 {
    ...
    // compare operator
    bool4 friend operator==(const int4& lhs, const int4& rhs);
    bool4 friend operator!=(const int4& lhs, const int4& rhs);
    bool4 friend operator<(const int4& lhs, const int4& rhs);
    bool4 friend operator<=(const int4& lhs, const int4& rhs);
    bool4 friend operator>(const int4& lhs, const int4& rhs);
