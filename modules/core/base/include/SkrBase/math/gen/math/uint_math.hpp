...
// abs
inline uint32_t abs(uint32_t v) { return ::std::abs(v); }
inline uint2 abs(const uint2& v) { return {::std::abs(v.x), ::std::abs(v.y)}; }
inline uint3 abs(const uint3& v) { return {::std::abs(v.x), ::std::abs(v.y), ::std::abs(v.z)}; }
inline uint4 abs(const uint4& v) { return {::std::abs(v.x), ::std::abs(v.y), ::std::abs(v.z), ::std::abs(v.w)}; }
