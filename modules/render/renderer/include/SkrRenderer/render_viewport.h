...
SKR_EXTERN_C SKR_RENDERER_API void skr_resolve_camera_to_viewport(const skr::scene::CameraComponent* camera, const skr::scene::TranslationComponent* translation, skr_render_viewport_t* viewport);
