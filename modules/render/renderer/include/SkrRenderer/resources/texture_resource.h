...
sreflect_enum_class(
    guid = "a9ff6d5f-620b-444b-8cb3-3b926ec1316e"
    serde = @bin|@json
)
...
sreflect_enum_class(
    guid = "01eccfa6-ac6c-4195-b725-66c865529d6f"
    serde = @bin|@json
)
...
sreflect_enum_class(
    guid = "b5dee0a2-5b20-4062-a036-79905b1d325f"
    serde = @bin|@json
)
...
sreflect_enum_class(
    guid = "566ef8d0-9c68-4578-be0b-b33781fc1a0f"
    serde = @bin|@json
)
...
sreflect_struct(
    guid = "ab483a53-5024-48f2-87a7-9502063c97f3"
    serde = @bin|@json
)
