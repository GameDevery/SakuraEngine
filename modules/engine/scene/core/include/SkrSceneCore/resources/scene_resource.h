...
#ifndef __meta__
    #include "SkrSceneCore/resources/scene_resource.generated.h" // IWYU pragma: export
#endif
...
class SKR_SCENE_CORE_API SceneFactory : public ResourceFactory
{
public:
...
{
template <>
struct SKR_SCENE_CORE_API BinSerde<skr_scene_resource_t>
{
