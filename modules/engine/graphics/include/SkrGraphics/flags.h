...
typedef enum ECGPUBufferViewUsage
{
    ...
    CGPU_BUFFER_VIEW_USAGE_PUSH_CONSTANT = (1 << 30),
    CGPU_BUFFER_VIEW_USAGE_MAX_ENUM_BIT = 0x7FFFFFFF
} ECGPUBufferViewUsage;
typedef uint32_t CGPUBufferViewUsages;

typedef enum ECGPUTexutreViewUsage
{
    CGPU_TEXTURE_VIEW_USAGE_SRV = 0x01,
    CGPU_TEXTURE_VIEW_USAGE_RTV_DSV = 0x02,
    CGPU_TEXTURE_VIEW_USAGE_UAV = 0x04,
    CGPU_TEXTURE_VIEW_USAGE_MAX_ENUM_BIT = 0x7FFFFFFF
