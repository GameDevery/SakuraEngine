...
{
    Importer* (*Load)(const AssetMetaFile* record, skr::archive::JsonReader* object);
    uint32_t (*Version)();
};

struct ImporterRegistry
{
    virtual Importer* LoadImporter(const AssetMetaFile* record, skr::archive::JsonReader* object, skr::GUID* pGuid = nullptr) = 0;
...
void skd::asset::RegisterImporter(skr::GUID guid)
{
    ...
    auto loader =
        +[](const AssetMetaFile* record, skr::archive::JsonReader* object) -> Importer* {
