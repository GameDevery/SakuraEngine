...
// void SimpleMesh::generate_mesh_resource(skr::RenderDevice* render_device, RenderMesh* render_mesh) SKR_NOEXCEPT
// {
// }

void SimpleMesh::generate_render_mesh(skr::RenderDevice* render_device, skr::RenderMesh* render_mesh) SKR_NOEXCEPT
{
