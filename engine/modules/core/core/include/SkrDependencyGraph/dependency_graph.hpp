...
public:
    ...
    uint32_t foreach_incoming_edges(skr::stl_function<void(DependencyGraphNode* from, DependencyGraphNode* to, DependencyGraphEdge* edge)>) SKR_NOEXCEPT;
    uint32_t foreach_outgoing_edges(skr::stl_function<void(DependencyGraphNode* from, DependencyGraphNode* to, DependencyGraphEdge* edge)>) SKR_NOEXCEPT;
